            ...
            <ol className="curriculum-list">
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    {copy(
                      "Nếu chọn chưa đúng, Hana sẽ hướng dẫn tối đa ba bước kèm hình minh họa. Sau bước cuối, bạn tự thử lại câu đó. Bấm Điểm hiện tại để xem Cấp hành trình và huy hiệu tiếp theo, Đổi nhiệm vụ để giữ điểm, hoặc Kết thúc lượt để xem tổng kết và lưu ảnh kỷ niệm.",
                      "If an answer is not right yet, Hana gives up to three guided steps with a picture. After the final step, you try that question yourself. Tap Current points to view your Journey Level and next badge, Change mission to keep your points, or End session to see your summary and save a souvenir image."
                    )}
                  </p>
                </div>
              </li>
